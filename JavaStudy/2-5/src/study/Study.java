...
public class Study {
    ...
    public static void main(String args[]) {
        ...
        /*
         * [ここへ記述]
         *shopMapに入っている、"牛乳”配列1に入れ、180と合わせる。
         */
        ...
        for (String sa : shohinList) {
        	System.out.println(sa + "=" +shopMap.get(sa) + "になります！");
        }

//        for(Entry<String, Integer> entry : LinkedHashMap.shopMap()) {
